...
const CssPage = () => {
  ...
  const QA = [
    ...
    },
    {
      ...
      answer: [
        "1] You can write CSS once and reuse the same sheet on multiple HTML pages.",
        "2] CSS is considered a clean coding technique, which means search engines won't have to struggle to “read” its content.",
        "3] It provides powerful control over the presentation of an HTML document.",
        "4] CSS can store web applications locally with the help of an offline cache.",
        "5] Using of this we can view offline websites.",
        "6] To make a global change simply change the style, and all elements in all the webpages will be updated automatically."
      ]
    },
    {
      id: 3,
    ...
    },
    {
      ...
      answer: [
        "1] CSS provides a way to present the same content in multiple presentation formats in mobile or desktop or laptop.",
        "2] To make a global change, simply change the style, and all elements in all the web pages will be updated automatically.",
        "3] Easy to maintain"
      ]
    },
    {
      ...
      answer: [
        ...
        "    # px ( pixel ) ==> 1/96 of 1in  ( 96 px = 1 inch)",
        "    # pt ( point ) ==> 1/72 of 1in  ( 72 pt = 1 inch)",
        "    # pc ( picas ) ==> 1pc = 12pt ",
        "    # cm (centimeter) ==> 1cm = 37.80px",
        "    # mm (milimeter) ==> 10mm = 1cm",
        "    # in (inche) ==> 1in = 96px",
        "\n2] Relative Units ==> are “relative or dependent” , they scale relative to the parent or window size.",
        "                         useful for styling responsive sites",
        "     # % ==> Relative to the parent element's value for that property",
        "     # em ==> Relative to parent's font size",
        "     # rem ==> Relative to root font size ",
        "     # vh ==> 1vh = 1/100 of the viewport's height",
        "     # vw ==> 1vw = 1/100 of the viewport's width",
        "     # vmin ==> Relative to viewport's smaller dimension , vmin = 1/100 of viewport's smaller dimension ( width / height).",
        "     # vman ==> Relative to viewport's larger dimension ,  1vmax = 1/100 of viewport's larger dimension  ( width / height).",
      ]
    },
    {
      id: 7,
      ...
      answer: [
        ...
        "     2] id selector    ==> used with a '#' character.",
      ]
    },
    {
      id: 8,
    ...
    },
    {
      ...
      answer: [
        "# RGBA / rgba contains A / a (alpha) which specifies the transparency of elements. ",
    ...
    },
    {
      ...
      answer: [
        ...
        "   # background-attachment ==> This property is used to fix the background ground image.",
        "                                       The image will not scroll with the page.",
        "   # background-position ==> used to set the image to a particular position."
    ...
    },
    {
      ...
      answer: [
        ...
        " 2] text-align       ==> Specifies the horizontal alignment of text within its container (left, center, right, justify).",
    ...
    },
    {
      ...
      answer: [
        " // Display property is used to hide and show the content ,",
    ...
    },
    {
      ...
      answer: [
        ...
        "       # Overflow-x and Overflow-y ==> This property specifies how to change the overflow of elements."
      ]
    },
    {
      id: 22,
      ...
      answer: [
        ...
        "       #  float : inherit  ==> The element inherits the floating property of its parent",
    ...
    },
    {
      ...
      answer: [
        ...
        "//  by default get margin (because of block)"
      ]
    },
    {
      id: 24,
      ...
      answer: [
        ...
        "    #  :hover psuedo class   ==> used to add a special effect to an element when our mouse pointer is over it.",
        "    #  :active pseudo class  ==> used to select an element that is activated when the user clicks on it. ",
        "    #  :focus psuedo class   ==>  used to select an element that is currently focussed by the user.",
        "    #  :visited psuedo class ==> used to select the links which have been already visited by the user."
      ]
    },
    {
      id: 25,
